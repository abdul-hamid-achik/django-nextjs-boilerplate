    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center">
            ...
            <div className="mx-auto sm:max-w-xl flex items-center justify-center flex-col">
                ...
                <p className="text-gray-700 my-4">
                    This template is designed to make it easy to quickly bootstrap a full stack application following
                    modern practices.
                ...
                <a href="https://github.com/sicksid/django-nextjs-project-template"
                   className="inline-block py-2 px-4 rounded-md text-white bg-indigo-600 hover:bg-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    View on GitHub
                </a>
            </div>
        </div>
